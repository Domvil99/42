# push_swap_mandatory Study Report
...
- Proyecto cubierto: `42/C/push_swap_mandatory`.
- Fuera de alcance: checker bonus y cualquier regla `bonus`.
...
- `make` en `42/C/push_swap_mandatory`: OK.
...
2. `push_swap_mandatory.md` (este archivo): marco global.
...
- 2026-03-14: version inicial completa del informe dedicated para
  `push_swap_mandatory` con evidencia real de build/funcional/rendimiento/memoria.
