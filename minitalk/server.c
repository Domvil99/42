...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2026/04/05 10:18:07 by saospina          #+#    #+#             */
/*   Updated: 2026/04/05 10:18:07 by saospina         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
static void	handle_signal(int sig, siginfo_t *info, void *context)
{
	...
	if (g_server_state.active_client == 0)
		g_server_state.active_client = info->si_pid;
	if (sig == MT_SIG_ONE)
	...
	if (g_server_state.bit_index == 8)
	{
		...
		reset_state(g_server_state.active_client);
	}
}
